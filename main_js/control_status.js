...
function tableInfo(ABC) {
    
    var ABC = JSON.parse(ABC);
    document.getElementById('totalLoadsPower').innerHTML = ABC.total_load_power_sum;
    document.getElementById('taipowerLoadsCost').innerHTML = ABC.taipower_loads_cost;
    document.getElementById('threeLevelLoadsCost').innerHTML = ABC.three_level_loads_cost;
    document.getElementById('realBuyGrid').innerHTML = ABC.real_buy_grid_cost;
    document.getElementById('min_FC_cost').innerHTML = ABC.min_FC_cost;
    document.getElementById('consumption').innerHTML = ABC.consumption;
}
